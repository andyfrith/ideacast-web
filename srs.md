...
- Web application for busy Influencer designers (entrepreneurs) to capture, format, and publish content ideas.
- Supports raw text input, image and video uploads.
- Uses LLM-powered templates to generate platform-specific content (initially for Instagram, eventually for YouTube, X and LinkedIn).
...
- **Social Integrations Table:**
  - Integration ID, user ID (foreign key), platform (Instagram, YouTube, LinkedIn, X), OAuth tokens, integration status.
